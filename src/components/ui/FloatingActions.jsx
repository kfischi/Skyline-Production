...
export default function FloatingActions({ contactInfo }) {
  ...
  return (
    <div className={styles.floatingActions}>
      ...
      {/* כפתורי משנה */}
      <div className={`${styles.subButtons} ${isExpanded ? styles.show : ''}`}>
        <button 
          className={`${styles.subButton} ${styles.whatsapp}`}
        ...
        <button 
          className={`${styles.subButton} ${styles.phone}`}
          onClick={handlePhone}
        ...
        <button 
          className={`${styles.subButton} ${styles.email}`}
